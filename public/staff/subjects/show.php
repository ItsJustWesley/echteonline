  ...
  <div class="subject show">
    ...
    <div class="attributes">
      ...
      <dl>
        ...
        <dl>
            <dt>Visit counter</dt>
            <dd><?php echo h($subject['visit_counter']); ?></dd>
        </dl>
    </div>
    ...
    <div class="pages listing">
      ...
      <div class="actions">
        ...
        <div class="action"> <a href="<?php echo url_for('/staff/pages/reset.php'); ?>">Reset visit counters</a>
      </div>
        ...
        <?php while($page = mysqli_fetch_assoc($page_set)) { ?>
          ...
          <tr>
            ...
            <td><?php echo h($page['menu_name']); ?></td>
              <td><?php echo h($page['visit_counter']); ?></td>
              <td><?php echo h($page['datealtered']); ?></td>
            <td><?php echo h($page['username']); ?></td>
            <td><?php echo h($page['createdate']);?></td>

...
<div id="content">
  <div class="subjects listing">
    ...
    <div class="actions">
     ...
     <div <a class="action"> <a href="<?php echo url_for('/staff/subjects/reset.php'); ?>">Reset visit counters</a> </div>
      ...
      <?php while($subject = mysqli_fetch_assoc($subject_set)) { ?>
        ...
        <tr>
          ...
          <td><?php echo $subject['visible'] == 1 ? 'true' : 'false'; ?></td>
            ...
            <td><?php echo h($subject['visit_counter']); ?> </td>
            <td><?php echo h($subject['username']); ?> </td>
            <td><?php echo h($subject['createdate']); ?> </td>

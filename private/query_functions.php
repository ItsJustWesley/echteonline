<?php
  ...
  function insert_subject($subject) {
    ...
    $sql .= "(menu_name, position, visible, username) ";
    $sql .= "VALUES (";
...
function count_visitsubject ($subject) {
    global $db;
    ...
    $sql = "UPDATE subjects SET ";
    $sql .= "visit_counter = visit_counter + 1 ";
    $sql .= "WHERE id='" . db_escape($db, $subject['id']) . "' ";
    $sql .= "LIMIT 1";
...
function count_visitpages ($page) {
    global $db;
...
// function add_datetosubject($subject) {
...
function add_admintopage() {
  ...
  function insert_page($page) {
    ...
    $sql .= "(subject_id, menu_name, position, visible, username, content) ";
    $sql .= "VALUES (";
    $sql .= "'" . db_escape($db, $page['subject_id']) . "',";
    $sql .= "'" . db_escape($db, $page['menu_name']) . "',";
    $sql .= "'" . db_escape($db, $page['position']) . "',";
    $sql .= "'" . db_escape($db, $page['visible']) . "',";
    $sql .= "'" . db_escape($db, $page['username']) . "',";
